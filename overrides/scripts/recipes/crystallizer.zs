...
var distillerTime = 200 as int;
var distillerEnergy = 20000 as int;
...
Distiller.addRecipe(<fluid:distwater>*1000, <fluid:water>*1000, <qmd:chemical_dust:3>,distillerEnergy,distillerTime,0.1);
